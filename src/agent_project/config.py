...
class Settings:
    ...
    local_vllm_model: str = "Qwen3.8-27B"
    ...
    agent_embedding_model_path: str = (
        "/home/qingao/models/embedding/Qwen__Qwen3-Embedding-0.6B"
    )
...
def load_settings() -> Settings:
    ...
    return Settings(
        model_provider=os.getenv("MODEL_PROVIDER", "local-vllm").strip().lower(),
        ...
        local_vllm_model=os.getenv("LOCAL_VLLM_MODEL", "Qwen3.8-27B"),
